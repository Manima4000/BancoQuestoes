    ...
    definition: {
        ...
        components: {
            schemas: {
                ...
                // Schemas de Origem (Entidade Separada)
                OrigemInput: {
                    type: 'object',
                    required: ['tipo', 'nome'],
                    properties: {
                        ...
                        nome: {
                            type: 'string',
                            description: 'Nome da origem (ex: FUVEST, ENEM, Halliday)',
                        },
                        ano: {
                            type: 'number',
                            description: 'Ano da prova/edição (opcional)',
                        },
                        informacoes_adicionais: {
                            type: 'string',
                            description: 'Informações adicionais (ex: 1ª Fase, Capítulo 5)',
                        },
                    },
                },
                Origem: {
                    allOf: [
                        { $ref: '#/components/schemas/OrigemInput' },
                        {
                            type: 'object',
                            properties: {
                                _id: { type: 'string', description: 'ID único da origem' },
                ...
                QuestaoInput: {
                    type: 'object',
                    required: ['enunciado', 'assunto_ids', 'tipo', 'dificuldade', 'gabarito'],
                    properties: {
                        enunciado: {
                            type: 'array',
                        ...
                        origem_id: {
                            type: 'string',
                            description: 'ID da origem da questão (opcional)',
                        },
                    },
                },
                Questao: {
                ...
                ListaExerciciosInput: {
                    ...
                    properties: {
                        ...
                        dificuldade_geral: {
                            type: 'string',
                            enum: ['facil', 'media', 'dificil', 'muito_dificil', 'mista'],
                        },
        ...
        tags: [
            ...
            { name: 'Origens', description: 'Operações de origens (vestibulares, livros, etc.)' },
