...
const GeminiQuestionSchema_1 = require("../schemas/GeminiQuestionSchema");
class GeminiParserService {
    async parseMarkdownToQuestions(markdownText) {
        ...
        const model = genAI.getGenerativeModel({
            ...
            generationConfig: {
                ...
                responseSchema: GeminiQuestionSchema_1.geminiQuestionSchema,
...
exports.default = new GeminiParserService();
